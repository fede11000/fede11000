...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-07-2022 a las 15:51:36
...
INSERT INTO `register` (`id_reg`, `nombre`, `contraseña`, `correo`) VALUES
...
(3, 'fusil de asalto', 'ak-47', 'unión sovietica', 1),
...
--
ALTER TABLE `register`
  MODIFY `id_reg` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
